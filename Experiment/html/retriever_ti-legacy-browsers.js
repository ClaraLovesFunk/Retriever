...
function instructionsLoopLoopBegin(thisScheduler) {
  ...
  instructionsLoop.forEach(function() {
...
function presentACresultsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  presentACresults.forEach(function() {
...
function practiceBlocksRoutineBegin(trials) {
  return function () {
    ...
    practiceBlocksComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function PracFeedb_2RoutineBegin(trials) {
  return function () {
    ...
    PracFeedb_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function attentionCheckPracRoutineBegin(trials) {
  return function () {
    ...
    attentionCheckPracComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function disturbanceRoutineBegin(trials) {
  return function () {
    ...
    disturbanceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function quitExperimentRoutineBegin(trials) {
  return function () {
    ...
    quitExperimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function LoopControl_2RoutineBegin(trials) {
  return function () {
    ...
    LoopControl_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function fixation_mainRoutineBegin(trials) {
  return function () {
    ...
    fixation_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ContinueOrEnd2RoutineBegin(trials) {
  return function () {
    ...
    ContinueOrEnd2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function quitExperiment2RoutineBegin(trials) {
  return function () {
    ...
    quitExperiment2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function BlockFeedbackRoutineBegin(trials) {
  return function () {
    ...
    BlockFeedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function freeResponseRoutineBegin(trials) {
  return function () {
    ...
    freeResponseComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function finishExperimentRoutineBegin(trials) {
  return function () {
    ...
    finishExperimentComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
