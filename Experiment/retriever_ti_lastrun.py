...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/clarawicharz/Desktop/Write/gitPavlovia/retriever_ti_lastrun.py',
...
current_img = 'html/resources/instructions/Slide' + str(img_no) + '.jpg'


# Initialize components for Routine "practiceBlocks"
practiceBlocksClock = core.Clock()
...
main_task_blocks = (("condition_files/conditions_main_" + str(expInfo["participant"])) + ".xlsx")
...
ContinueOrEnd2Clock = core.Clock()
numberQuits2 = 0
...
quitExperiment2Clock = core.Clock()

# Initialize components for Routine "BlockFeedback"
BlockFeedbackClock = core.Clock()
...
text = visual.TextStim(win=win, name='text',
    ...
    languageStyle='LTR',
    depth=0.0);
ask_for_feedb = visual.TextStim(win=win, name='ask_for_feedb',
...
finishExperimentClock = core.Clock()
...
for thisInstructionsLoop in instructionsLoop:
    ...
    if (img_no > 1) and ((keyNext.keys == str('left')) or (keyNext.keys == 'left')):
        img_no -= 1
    elif (img_no < 16) and ((keyNext.keys == str('right')) or (keyNext.keys == 'right')):
        img_no += 1
    elif (img_no == 16) and ((keyNext.keys == 'space') or (keyNext.keys == str('space'))):
...
for thisRepPractice in repPractice:
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    practiceBlocksClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=practiceBlocksClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    practiceTrials = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('conditions_practice.xlsx', selection=myIndices),
    ...
    for thisPracticeTrial in practiceTrials:
        ...
        while continueRoutine:
            ...
            if fixcross.status == STARTED:
                if frameN >= (fixcross.frameNStart + jitter):
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if practiceP1.status == STARTED:
                ...
                if tThisFlipGlobal > practiceP1.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(practiceP1, 'tStopRefresh')  # time at next scr refresh
            ...
            if practiceP2.status == STARTED:
                ...
                if tThisFlipGlobal > practiceP2.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(practiceP2, 'tStopRefresh')  # time at next scr refresh
            ...
            if practiceKey.status == STARTED:
                ...
                if tThisFlipGlobal > practiceKey.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(practiceKey, 'tStopRefresh')  # time at next scr refresh
            ...
            if crossPractice.status == STARTED:
                ...
                if tThisFlipGlobal > crossPractice.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(crossPractice, 'tStopRefresh')  # time at next scr refresh
        ...
        for thisComponent in practiceComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        practiceTrials.addData('practiceP1.started', practiceP1.tStartRefresh)
        practiceTrials.addData('practiceP1.stopped', practiceP1.tStopRefresh)
        # check responses
        ...
        practiceTrials.addData('practiceKey.started', practiceKey.tStartRefresh)
        practiceTrials.addData('practiceKey.stopped', practiceKey.tStopRefresh)
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        PracFeedb_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=PracFeedb_2Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            ...
            if practiceFeedback.status == STARTED:
                ...
                if tThisFlipGlobal > practiceFeedback.tStartRefresh + 0.5-frameTolerance:
                    ...
                    win.timeOnFlip(practiceFeedback, 'tStopRefresh')  # time at next scr refresh
            ...
            if screenAfterFB.status == STARTED:
                ...
                if tThisFlipGlobal > screenAfterFB.tStartRefresh + durationBlank-frameTolerance:
                    ...
                    win.timeOnFlip(screenAfterFB, 'tStopRefresh')  # time at next scr refresh
        ...
        for thisComponent in PracFeedb_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        practiceTrials.addData('practiceFeedback.started', practiceFeedback.tStartRefresh)
        practiceTrials.addData('practiceFeedback.stopped', practiceFeedback.tStopRefresh)
        practiceTrials.addData('screenAfterFB.started', screenAfterFB.tStartRefresh)
        practiceTrials.addData('screenAfterFB.stopped', screenAfterFB.tStopRefresh)
    ...
    Attentions = data.TrialHandler(nReps=1, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('attentionChecks.xlsx', selection='0:4'),
    ...
    for thisAttention in Attentions:
        ...
        # keep track of which components have finished
        attentionCheckPracComponents = [key_respAC_prac, ac_stim_prac, Pos1_prac, Pos2_prac, Pos3_prac, Pos4_prac, taskAC_prac]
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        attentionCheckPracClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            tThisFlip = win.getFutureFlipTime(clock=attentionCheckPracClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            ...
            if key_respAC_prac.status == STARTED:
                ...
                if tThisFlipGlobal > key_respAC_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(key_respAC_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if ac_stim_prac.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > ac_stim_prac.tStartRefresh + 10-frameTolerance:
                    # keep track of stop time/frame for later
                    ac_stim_prac.tStop = t  # not accounting for scr refresh
                    ac_stim_prac.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(ac_stim_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos1_prac.status == STARTED:
                ...
                if tThisFlipGlobal > Pos1_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos1_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos2_prac.status == STARTED:
                ...
                if tThisFlipGlobal > Pos2_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos2_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos3_prac.status == STARTED:
                ...
                if tThisFlipGlobal > Pos3_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos3_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos4_prac.status == STARTED:
                ...
                if tThisFlipGlobal > Pos4_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos4_prac, 'tStopRefresh')  # time at next scr refresh
            ...
            if taskAC_prac.status == STARTED:
                ...
                if tThisFlipGlobal > taskAC_prac.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(taskAC_prac, 'tStopRefresh')  # time at next scr refresh
        ...
        Attentions.addData('key_respAC_prac.started', key_respAC_prac.tStartRefresh)
        Attentions.addData('key_respAC_prac.stopped', key_respAC_prac.tStopRefresh)
        ...
        Attentions.addData('ac_stim_prac.started', ac_stim_prac.tStartRefresh)
        Attentions.addData('ac_stim_prac.stopped', ac_stim_prac.tStopRefresh)
        thisExp.nextEntry()
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    disturbanceClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=disturbanceClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
ContinueOrEndClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=ContinueOrEndClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisRepBlock in repBlocks:
    ...
    msgBlockNumber = 'You will start block ' + str(thisBlock) + ' out of 8. \nRemember that both accuracy and speed matter. \n[Press space bar to begin.]'
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    LoopControl_2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=LoopControl_2Clock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    for thisTrial in trials:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        fixation_mainClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=fixation_mainClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            ...
            if fixcross_2.status == STARTED:
                if frameN >= (fixcross_2.frameNStart + jitter):
                    # keep track of stop time/frame for later
                    fixcross_2.tStop = t  # not accounting for scr refresh
                    fixcross_2.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(fixcross_2, 'tStopRefresh')  # time at next scr refresh
        ...
        for thisComponent in fixation_mainComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trials.addData('fixcross_2.started', fixcross_2.tStartRefresh)
        trials.addData('fixcross_2.stopped', fixcross_2.tStopRefresh)
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if imageP1.status == STARTED:
                ...
                if tThisFlipGlobal > imageP1.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(imageP1, 'tStopRefresh')  # time at next scr refresh
            ...
            if imageP2.status == STARTED:
                ...
                if tThisFlipGlobal > imageP2.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(imageP2, 'tStopRefresh')  # time at next scr refresh
            ...
            if cross_objects.status == STARTED:
                ...
                if tThisFlipGlobal > cross_objects.tStartRefresh + 2.5-frameTolerance:
                    ...
                    win.timeOnFlip(cross_objects, 'tStopRefresh')  # time at next scr refresh
                    cross_objects.setAutoDraw(False)
            if cross_objects.status == STARTED:  # only update if drawing
                cross_objects.setOpacity(crossDisappear_Main, log=False)
        ...
        for thisComponent in trialComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trials.addData('imageP1.started', imageP1.tStartRefresh)
        trials.addData('imageP1.stopped', imageP1.tStopRefresh)
        trials.addData('imageP2.started', imageP2.tStartRefresh)
        trials.addData('imageP2.stopped', imageP2.tStopRefresh)
        # check responses
        ...
        trials.addData('blankScreen2.started', blankScreen2.tStartRefresh)
        trials.addData('blankScreen2.stopped', blankScreen2.tStopRefresh)
    ...
    trials_AC = data.TrialHandler(nReps=repsAC, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('attentionChecks.xlsx'),
    ...
    for thisTrials_AC in trials_AC:
        ...
        Pos4.setText(Loc4)
        # keep track of which components have finished
        attentionCheckComponents = [key_respAC, ac_stim, Pos1, Pos2, Pos3, Pos4, shapeInstructions]
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if key_respAC.status == STARTED:
                ...
                if tThisFlipGlobal > key_respAC.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(key_respAC, 'tStopRefresh')  # time at next scr refresh
            ...
            if ac_stim.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > ac_stim.tStartRefresh + 10-frameTolerance:
                    # keep track of stop time/frame for later
                    ac_stim.tStop = t  # not accounting for scr refresh
                    ac_stim.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(ac_stim, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos1.status == STARTED:
                ...
                if tThisFlipGlobal > Pos1.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos1, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos2.status == STARTED:
                ...
                if tThisFlipGlobal > Pos2.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos2, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos3.status == STARTED:
                ...
                if tThisFlipGlobal > Pos3.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos3, 'tStopRefresh')  # time at next scr refresh
            ...
            if Pos4.status == STARTED:
                ...
                if tThisFlipGlobal > Pos4.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(Pos4, 'tStopRefresh')  # time at next scr refresh
            ...
            if shapeInstructions.status == STARTED:
                ...
                if tThisFlipGlobal > shapeInstructions.tStartRefresh + 10-frameTolerance:
                    ...
                    win.timeOnFlip(shapeInstructions, 'tStopRefresh')  # time at next scr refresh
        ...
        trials_AC.addData('key_respAC.started', key_respAC.tStartRefresh)
        trials_AC.addData('key_respAC.stopped', key_respAC.tStopRefresh)
        if key_respAC.corr:
            AC_acc = 1
        ...
        trials_AC.addData('ac_stim.started', ac_stim.tStartRefresh)
        trials_AC.addData('ac_stim.stopped', ac_stim.tStopRefresh)
        thisExp.nextEntry()
    ...
    for thisPresentACresult in presentACresults:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        ContinueOrEnd2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=ContinueOrEnd2Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
        ...
        for thisComponent in ContinueOrEnd2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        presentACresults.addData('textEndExperiment.started', textEndExperiment.tStartRefresh)
        presentACresults.addData('textEndExperiment.stopped', textEndExperiment.tStopRefresh)
    ...
    for thisQuitExpLoop2 in quitExpLoop2:
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        quitExperiment2Clock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        ...
        while continueRoutine:
            ...
            tThisFlip = win.getFutureFlipTime(clock=quitExperiment2Clock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    BlockFeedbackClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=BlockFeedbackClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
    ...
    for thisComponent in BlockFeedbackComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    repBlocks.addData('feedbBlocks.started', feedbBlocks.tStartRefresh)
    repBlocks.addData('feedbBlocks.stopped', feedbBlocks.tStopRefresh)
...
for thisBonusLoop in BonusLoop:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    # Pick three random number from the accuracy counter
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    bonusClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    ...
    while continueRoutine:
        ...
        tThisFlip = win.getFutureFlipTime(clock=bonusClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
...
continueRoutine = True
# update component parameters for each repeat
# Code in this part is from https://gitlab.pavlovia.org/demos/textinput/
text.text = ''
modify = False
event.clearEvents('keyboard')
# keep track of which components have finished
freeResponseComponents = [text, ask_for_feedb]
for thisComponent in freeResponseComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
freeResponseClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "freeResponse"-------
while continueRoutine:
    # get current time
    t = freeResponseClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=freeResponseClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if ask_for_feedb.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
        # keep track of start time/frame for later
        ask_for_feedb.frameNStart = frameN  # exact frame index
        ask_for_feedb.tStart = t  # local t and not account for scr refresh
        ask_for_feedb.tStartRefresh = tThisFlipGlobal  # on global time
        win.timeOnFlip(ask_for_feedb, 'tStartRefresh')  # time at next scr refresh
...
for thisComponent in freeResponseComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData("comments", subjectText.text)
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
finishExperimentClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1
...
while continueRoutine:
    ...
    tThisFlip = win.getFutureFlipTime(clock=finishExperimentClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisComponent in finishExperimentComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('finalText.started', finalText.tStartRefresh)
thisExp.addData('finalText.stopped', finalText.tStopRefresh)
